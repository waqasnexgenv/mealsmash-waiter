...
import 'package:Mealsmash_Waiter/pages/SPayNowPage.dart';
import 'package:Mealsmash_Waiter/pages/login.dart';
import 'package:Mealsmash_Waiter/helper/colors.dart';
import 'package:Mealsmash_Waiter/helper/strings.dart';
import 'package:Mealsmash_Waiter/pages/order_placed.dart';
import 'package:Mealsmash_Waiter/pages/pastorders.dart';
import 'package:Mealsmash_Waiter/pages/pay_now_page.dart';
import 'package:Mealsmash_Waiter/pages/payment_success_page.dart';
import 'package:Mealsmash_Waiter/pages/printer_setup.dart';
import 'package:Mealsmash_Waiter/pages/qr_screen.dart';
import 'package:Mealsmash_Waiter/pages/search_result_page.dart';

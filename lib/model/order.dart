...
class Order {
  ...
  factory Order.fromJson(String str) => Order.fromJson(json.decode(str));
  ...
  factory Order.fromMap(Map<String, dynamic> json) => Order(
        ...
        commission:
            json["commission"] == null ? null : json["commission"].toString(),
...
class OrderMeta {
  ...
  factory OrderMeta.fromJson(String str) =>
      OrderMeta.fromJson(json.decode(str));
  ...
  factory OrderMeta.fromMap(Map<String, dynamic> json) => OrderMeta(
        ...
        orderItemExtras: json["order_item_extras"] == null
            ? null
            : List<OrderItemExtra>.from(json["order_item_extras"]
                .map((x) => OrderItemExtra.fromMap(x))),
      );
...
class OrderItemExtra {
  ...
  factory OrderItemExtra.fromJson(String str) =>
      OrderItemExtra.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory OrderItemExtra.fromMap(Map<String, dynamic> json) => OrderItemExtra(
        id: json["id"] == null ? null : json["id"],
